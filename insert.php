...
<table align="center" bgcolor="#B7E2F3" border="4" bordercolor="#0000FF">
		<tr>
				<td>Name</td>
				<td>:</td>
		...
		<tr>
				...
				<td>
					...
					writing<input type="checkbox" name="hobb[]" value="writin"/>
					reading<input type="checkbox" name="hobb[]" value="reading"/>				
				</td>
		</tr>
		<tr>
				<td>Country</td>
